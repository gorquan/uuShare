...
public:
	...
	virtual string getCipherName() noexcept { return Util::emptyString; }
	virtual ByteVector getKeyprint() const noexcept { return vector<uint8_t>(); }
	...
	socket_t getHandle() const { return sock; }
