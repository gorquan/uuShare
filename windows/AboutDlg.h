...
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
		SetDlgItemText(IDC_VERSION, _T("uuShare v") _T(VERSIONSTRING_FULL) _T("\n(c) Copyright 2016 XUULM.com\nBased on: ApexDC++ (c) Copyright 2006-2016 ApexDC++ Development Team"));
